...
/*   Updated: 2025/06/20 23:11:24 by rmarkov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_count_zero_padding(int precision, int num_len, int *zero_padding);
void		ft_count_space_padding(int width, int zero_and_num_len, char sign, int *space_padding);
